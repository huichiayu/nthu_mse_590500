...
<table style="width:100%; table-layout: fixed; border-collapse: collapse;">
  ...
  <tr> <!-- week 1 -->
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Course syllabus, overview, instructor's self intro, software installation, Python basics.</td>
  </tr> 
  ...
  <tr style="background-color: #f9f9f9;"> <!-- week 7 -->
    ...
    <td style="border: 1px solid #ddd; padding: 8px;"><span style="color: red;">Holiday. No class.</td>
  </tr> 
   <tr> <!-- week 8 -->
  ...
  <tr style="background-color: #f9f9f9;"> <!-- week 9 -->
    ...
    <td style="border: 1px solid #ddd; padding: 8px;">Differential equation, quick course content review</td>
  </tr>
  <tr> <!-- week 10 -->
  ...
  <tr style="background-color: #f9f9f9;"> <!-- week 11 -->
    ...
    <td style="border: 1px solid #ddd; padding: 8px;"> Beam problem, Fourier series, FFT. May 8: <strong>Homework 2-3 release</strong> </td>
  </tr>       
  <tr> <!-- week 12 -->
    <td style="border: 1px solid #ddd; padding: 8px;">11 (May 11)</td>
    <td style="border: 1px solid #ddd; padding: 8px;">Image filters, image processing </td>
  </tr>
  <tr style="background-color: #f9f9f9;"> <!-- week 13 -->
    <td style="border: 1px solid #ddd; padding: 8px;">12 (May 18)</td>
    <td style="border: 1px solid #ddd; padding: 8px;">(remote class) Object-oriented programming, regression</td>
  </tr>       
  <tr> <!-- week 14 -->
